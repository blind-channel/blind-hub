...
extern "C" {
    ...
    pub fn __gmpz_init(x: mpz_ptr);
    pub fn __gmpz_init2(x: mpz_ptr, n: mp_bitcnt_t);
    pub fn __gmpz_init_set(rop: mpz_ptr, op: mpz_srcptr);
    pub fn __gmpz_init_set_ui(rop: mpz_ptr, op: c_ulong);
    pub fn __gmpz_init_set_str(rop: mpz_ptr, s: *const c_char, base: c_int) -> c_int;
    pub fn __gmpz_clear(x: mpz_ptr);
    pub fn __gmpz_realloc2(x: mpz_ptr, n: mp_bitcnt_t);
    pub fn __gmpz_size(x: mpz_ptr) -> c_int;
    pub fn __gmpz_set(rop: mpz_ptr, op: mpz_srcptr);
    pub fn __gmpz_set_str(rop: mpz_ptr, s: *const c_char, base: c_int) -> c_int;
    pub fn __gmpz_get_str(s: *mut c_char, base: c_int, op: mpz_srcptr) -> *mut c_char;
    pub fn __gmpz_get_ui(op: mpz_srcptr) -> c_ulong;
    pub fn __gmpz_fits_ulong_p(op: mpz_srcptr) -> c_int;
    pub fn __gmpz_get_si(op: mpz_srcptr) -> c_ulong;
    pub fn __gmpz_get_d(op: mpz_srcptr) -> c_double;
    pub fn __gmpz_fits_slong_p(op: mpz_srcptr) -> c_long;
    pub fn __gmpz_sizeinbase(op: mpz_srcptr, base: c_int) -> size_t;
    pub fn __gmpz_cmp(op1: mpz_srcptr, op2: mpz_srcptr) -> c_int;
    pub fn __gmpz_cmp_ui(op1: mpz_srcptr, op2: c_ulong) -> c_int;
    pub fn __gmpz_add(rop: mpz_ptr, op1: mpz_srcptr, op2: mpz_srcptr);
    pub fn __gmpz_add_ui(rop: mpz_ptr, op1: mpz_srcptr, op2: c_ulong);
    pub fn __gmpz_sub(rop: mpz_ptr, op1: mpz_srcptr, op2: mpz_srcptr);
    pub fn __gmpz_sub_ui(rop: mpz_ptr, op1: mpz_srcptr, op2: c_ulong);
    pub fn __gmpz_ui_sub(rop: mpz_ptr, op1: c_ulong, op2: mpz_srcptr);
    pub fn __gmpz_mul(rop: mpz_ptr, op1: mpz_srcptr, op2: mpz_srcptr);
    pub fn __gmpz_mul_ui(rop: mpz_ptr, op1: mpz_srcptr, op2: c_ulong);
    pub fn __gmpz_mul_si(rop: mpz_ptr, op1: mpz_srcptr, op2: c_long);
    pub fn __gmpz_mul_2exp(rop: mpz_ptr, op1: mpz_srcptr, op2: mp_bitcnt_t);
    pub fn __gmpz_neg(rop: mpz_ptr, op: mpz_srcptr);
    pub fn __gmpz_abs(rop: mpz_ptr, op: mpz_srcptr);
    pub fn __gmpz_tdiv_q(q: mpz_ptr, n: mpz_srcptr, d: mpz_srcptr);
    pub fn __gmpz_tdiv_r(r: mpz_ptr, n: mpz_srcptr, d: mpz_srcptr);
    pub fn __gmpz_tdiv_q_ui(q: mpz_ptr, n: mpz_srcptr, d: c_ulong);
    pub fn __gmpz_tdiv_r_ui(r: mpz_ptr, n: mpz_srcptr, d: c_ulong);
    pub fn __gmpz_fdiv_r(r: mpz_ptr, n: mpz_srcptr, d: mpz_srcptr);
    ...
    pub fn __gmpz_com(rop: mpz_ptr, op: mpz_srcptr);
    pub fn __gmpz_popcount(op: mpz_srcptr) -> mp_bitcnt_t;
    pub fn __gmpz_pow_ui(rop: mpz_ptr, base: mpz_srcptr, exp: c_ulong);
    pub fn __gmpz_ui_pow_ui(rop: mpz_ptr, base: c_ulong, exp: c_ulong);
    pub fn __gmpz_powm(rop: mpz_ptr, base: mpz_srcptr, exp: mpz_srcptr, modulo: mpz_srcptr);
    pub fn __gmpz_powm_sec(rop: mpz_ptr, base: mpz_srcptr, exp: mpz_srcptr, modulo: mpz_srcptr);
    pub fn __gmpz_hamdist(op1: mpz_srcptr, op2: mpz_srcptr) -> mp_bitcnt_t;
    pub fn __gmpz_setbit(rop: mpz_ptr, bit_index: mp_bitcnt_t);
    pub fn __gmpz_clrbit(rop: mpz_ptr, bit_index: mp_bitcnt_t);
    pub fn __gmpz_combit(rop: mpz_ptr, bit_index: mp_bitcnt_t);
    pub fn __gmpz_tstbit(rop: mpz_srcptr, bit_index: mp_bitcnt_t) -> c_int;
    pub fn __gmpz_probab_prime_p(n: mpz_srcptr, reps: c_int) -> c_int;
    pub fn __gmpz_nextprime(rop: mpz_ptr, op: mpz_srcptr);
    pub fn __gmpz_gcd(rop: mpz_ptr, op1: mpz_srcptr, op2: mpz_srcptr);
    pub fn __gmpz_gcdext(g: mpz_ptr, s: mpz_ptr, t: mpz_ptr, a: mpz_srcptr, b: mpz_srcptr);
    pub fn __gmpz_lcm(rop: mpz_ptr, op1: mpz_srcptr, op2: mpz_srcptr);
    pub fn __gmpz_invert(rop: mpz_ptr, op1: mpz_srcptr, op2: mpz_srcptr) -> c_int;
    pub fn __gmpz_import(rop: mpz_ptr, count: size_t, order: c_int, size: size_t,
                     endian: c_int, nails: size_t, op: *const c_void);
    pub fn __gmpz_export(rop: *mut c_void, countp: *mut size_t, order: c_int, size: size_t, 
                     endian: c_int, nails: size_t, op: mpz_srcptr);
    pub fn __gmpz_root(rop: mpz_ptr, op: mpz_srcptr, n: c_ulong) -> c_int;
    ...
    pub fn __gmpz_swap(rop1: mpz_ptr, rop2: mpz_ptr);
    pub fn __gmpz_fdiv_qr(q: mpz_ptr, r: mpz_ptr, n: mpz_srcptr, d: mpz_srcptr);
}
